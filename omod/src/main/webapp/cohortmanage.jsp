...
<td class="tdStyle" > 
<a href="${pageContext.request.contextPath}/module/cohort/addcohortattributes.form?ca=${ls.cohortId}">Add Attribute</a>
</td>
<td class="tdStyle" > 
<a href="${pageContext.request.contextPath}/module/cohort/cpatients.form?cpid=${ls.cohortId}">Add Cohort Member</a>
</td>
<td class="tdStyle" > 
<a href="${pageContext.request.contextPath}/module/cohort/htmlFormEntry.form?coh=${ls.cohortId}&htmlformId=${htmlformId}">Add Encounter</a>
</td>
</tr>
</c:forEach>
</tbody>
